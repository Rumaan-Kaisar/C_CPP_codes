...
[1]	parameterized manipulator and 	[2]	 parameterless manipulator
...
ostream &setup(ostream &stream){	stream.width(10);
					stream.precision(4);
					stream.fill('*');
					return stream ;}	int main(){	cout <<setup<< 123.123456;
		return 0;}
...
istream &getpass(istream &stream){
		cout << '\a'; 	/* sound bell */ 
		cout << " Enter password : ";
		return stream ; }	int main(){ 	char pw[80];
/* comparing password */
		do{ cin >> getpass >> pw; }
